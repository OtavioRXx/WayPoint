...
🧩 RESUMÃO (visão macro)
Seu sistema tem basicamente 5 grandes blocos:
Usuários
Linhas e paradas
Reportes colaborativos
Ocorrências oficiais
Sistema inteligente (consenso + status)
...
⚙️ 3.2 Requisitos Não Funcionais (RNF)
((São como o sistema deve funcionar))
...
🧩 Escalabilidade (opcional, mas forte no TCC)
